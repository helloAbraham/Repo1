<template>
    <div>
      ...
      <p style="font-size: 25px; accent-color: purple; "><strong>Enter Time for Alert </strong>&ensp;</p>
      <BaseSelect 
    ...
    <!-- Using the Modal Component -->
     ...
     <div>
      ...
      <template #default>
        ...
        <BaseButtonStyle @click="showConfirm = false">OK</BaseButtonStyle>
      </template>
      <template #footer>
  ...
  import testImage from '@/assets/programcomputer.gif';
  export default {
